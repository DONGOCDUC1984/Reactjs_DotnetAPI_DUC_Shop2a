...
namespace ProjectAPI.Migrations
{
    ...
    [Migration("20241109034016_1-work")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectAPI.Models.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectAPI.Models.ProvinceCity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectAPI.Models.Auth.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ProjectAPI.Models.Cart", b =>
                {
                    b.HasOne("ProjectAPI.Models.Auth.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectAPI.Models.District", b =>
                {
                    b.HasOne("ProjectAPI.Models.ProvinceCity", "ProvinceCity")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectAPI.Models.Product", b =>
                {
                    ...
                    b.HasOne("ProjectAPI.Models.District", "District")
                        .WithMany()
